...
| Execution phasing | Phase 5D-0.1 Merged | The phases doc now records 5D-0.1 as merged and keeps map and social follow-on slices in candidate status pending renewed approval. |
