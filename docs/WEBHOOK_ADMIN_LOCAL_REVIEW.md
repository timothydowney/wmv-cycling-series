...
- collapsed rows are for quick scanning of webhook type, match outcome, and specific competition matches when they exist
...
- whether collapsed badges make specific week matches easy to spot
